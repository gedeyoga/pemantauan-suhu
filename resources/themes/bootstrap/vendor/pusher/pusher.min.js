    ...
    return (function (t) {
            ...
            var o = n(2),
                ...
                y = (function () {
                    function t(e, n) {
                        ...
                        i(e),
                            ...
                            (this.config = r.extend(
                                f.getGlobalConfig(),
                                n.cluster ? f.getClusterConfig(n.cluster) : {},
                                n
                            )),
                            ...
                            this.config.disableStats ||
                                (this.timelineSender = d[
                                    "default"
                                ].createTimelineSender(this.timeline, {
                                    host: this.config.statsHost,
                                    path:
                                        "/timeline/v2/" +
                                        o["default"].TimelineTransport.name,
                                }));
                        var y = function (t) {
                            var e = r.extend({}, l.config, t);
                            return u.build(
                                o["default"].getDefaultStrategy(e),
                                e
                            );
                        };
                        (this.connection = d["default"].createConnectionManager(
                            ...
                            this.connection.bind("connected", function () {
                                l.subscribeAll(),
                                    l.timelineSender &&
                                        l.timelineSender.send(
                                            l.connection.isEncrypted()
                                        );
                            }),
                    ...
                    return (
                        (t.ready = function () {
                            t.isReady = !0;
                            for (var e = 0, n = t.instances.length; n > e; e++)
                        ...
                        (t.prototype.isEncrypted = function () {
                            return "https:" === o["default"].getProtocol()
                                ? !0
                        ...
                        (t.DependenciesReceivers =
                            o["default"].DependenciesReceivers),
            ...
            var n = (function () {
                ...
                return (
                    (t.prototype.create = function (t) {
                        ...
                        return (
                            (this[e] = r),
                            { number: e, id: n, name: i, callback: r }
                        );
                    }),
                    ...
                    return (
                        (t.prototype.load = function (t, e, n) {
                            ...
                            if (i.loading[t] && i.loading[t].length > 0)
                                ...
                                i.loading[t] = [n];
                                var r = o["default"].createScriptRequest(
                                        i.getPath(t, e)
                                    ),
                                    s = i.receivers.create(function (e) {
                                        if (
                                            (i.receivers.remove(s),
                                            i.loading[t])
                                        ) {
                                            var n = i.loading[t];
                                            delete i.loading[t];
                        ...
                        (t.prototype.getRoot = function (t) {
                            var e,
                                n =
                                    o["default"].getDocument().location
                                        .protocol;
                            return (
                                (e =
            ...
            var i = n(9),
                ...
                r = {
                    debug: function () {
                        ...
                        o["default"].log &&
                            o["default"].log(
                                i.stringify.apply(this, arguments)
                            );
                    },
                    warn: function () {
                        for (var t = [], e = 0; e < arguments.length; e++)
            ...
            function o() {
                for (var t = ["Pusher"], e = 0; e < arguments.length; e++)
                    "string" == typeof arguments[e]
                        ? t.push(arguments[e])
                        : t.push(JSON.stringify(arguments[e]));
                return t.join(" : ");
            }
            function r(t, e) {
                    ...
                    return (
                        (t.prototype.send = function (t) {
                            if (!this.request) {
                                ...
                                (this.request =
                                    o["default"].createScriptRequest(n)),
                                    this.request.send(t);
                            }
                        }),
                        (t.prototype.cleanup = function () {
                ...
                r = function (t, e) {
                    return function (n, r) {
                        var s = "http" + (e ? "s" : "") + "://",
                            ...
                            u = i["default"].ScriptReceivers.create(function (
                                e,
                                n
                            ) {
        ...
        function (t, e, n) {
            ...
            (e.streamingConfiguration = r.extend(
                {
                    getSocket: function (t) {
                        return s["default"].HTTPFactory.createStreamingSocket(
                            t
                        );
                    },
                },
                ...
                (e.pollingConfiguration = r.extend(
                    {
                        getSocket: function (t) {
                            return s["default"].HTTPFactory.createPollingSocket(
                                t
                            );
                        },
                    },
            ...
            var i =
                ...
                u = (function (t) {
                    function e(e, n, i, o, r) {
                        t.call(this),
                            (this.initialize =
                                c["default"].transportConnectionInitializer),
                            (this.hooks = e),
                            (this.name = n),
                            (this.priority = i),
                            (this.key = o),
                ...
                r = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.isOnline = function () {
                            return void 0 === window.navigator.onLine
                                ? !0
            ...
            var i =
                ...
                a = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.close = function () {
                            this.unloader &&
                                (o["default"].removeUnloadListener(
                                    this.unloader
                                ),
                                (this.unloader = null)),
                                this.xhr &&
                        ...
                        var a,
                            c = !(
                                ...
                                (t.disabledTransports &&
                                    -1 !==
                                        l.arrayIndexOf(t.disabledTransports, e))
                            );
                        a = c
                            ? new d["default"](
                                  e,
                ...
                o = (function () {
                    ...
                    return (
                        (t.prototype.getAssistant = function (t) {
                            return i[
                                "default"
                            ].createAssistantToTheTransportManager(this, t, {
            ...
            var i = n(2),
                o = (function () {
                    function t(t, e) {
                        ...
                        if (
                            "undefined" ==
                            typeof i["default"].getAuthorizers()[n]
                        )
                            throw (
                    ...
                    return (
                        (t.prototype.send = function (t, e) {
                            this.timeline.isEmpty() ||
                                this.timeline.send(
                                    i["default"].TimelineTransport.getAgent(
                                        this,
                                        t
                                    ),
                                    e
                        ...
                        (e.prototype.handleEvent = function (t, e) {
                            switch (t) {
                                ...
                                case "pusher_internal:member_removed":
                                    ...
                                    break;
                                default:
                                    o["default"].prototype.handleEvent.call(
                                        this,
                                        t,
                                        e
                                    );
                ...
                s = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.authorize = function (t, e) {
                            var n = o["default"].createAuthorizer(
                                this,
                                this.pusher.config
                            );
                    ...
                    return (
                        ...
                        (e.prototype.retryIn = function (t) {
                            ...
                            this.timeline.info({ action: "retry", delay: t }),
                                ...
                                (this.retryTimer = new r.OneOffTimer(
                                    t || 0,
                                    function () {
                ...
                l = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.connect = function (t, e) {
                            ...
                            if (
                                i &&
                                i.timestamp + this.ttl >= a["default"].now()
                            ) {
